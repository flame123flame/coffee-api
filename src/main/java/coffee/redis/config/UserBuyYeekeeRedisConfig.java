...
public class UserBuyYeekeeRedisConfig {
	...
	private int port;
	final static String stc = "redisUserBuyYeekee";
	final static String factory = "redisUserBuyYeekeeFactory";
	final static String template = "redisUserBuyYeekeeTemplate";
